    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: const TextTheme(
          ...
          titleLarge: TextStyle(fontSize: 16.0, fontWeight: FontWeight.normal, color: Colors.black54),
          titleMedium: TextStyle(fontSize: 14.0, fontWeight: FontWeight.normal, color: Colors.black54),
        ),
      ),
